...
import nuxt_plugin_plugin_412a1a7e from 'nuxt_plugin_plugin_412a1a7e' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_workbox_1e67b2b0 from 'nuxt_plugin_workbox_1e67b2b0' // Source: ./workbox.js (mode: 'client')
import nuxt_plugin_nuxticons_1bc21334 from 'nuxt_plugin_nuxticons_1bc21334' // Source: ./nuxt-icons.js (mode: 'all')
import nuxt_plugin_googleanalytics_a90bbddc from 'nuxt_plugin_googleanalytics_a90bbddc' // Source: ./google-analytics.js (mode: 'client')
import nuxt_plugin_dayjsplugin_591e106e from 'nuxt_plugin_dayjsplugin_591e106e' // Source: ./dayjs-plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_412a1a7e === 'function') {
    await nuxt_plugin_plugin_412a1a7e(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_1e67b2b0 === 'function') {
    await nuxt_plugin_workbox_1e67b2b0(app.context, inject)
  }

  if (typeof nuxt_plugin_nuxticons_1bc21334 === 'function') {
    await nuxt_plugin_nuxticons_1bc21334(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_googleanalytics_a90bbddc === 'function') {
    await nuxt_plugin_googleanalytics_a90bbddc(app.context, inject)
  }

  if (typeof nuxt_plugin_dayjsplugin_591e106e === 'function') {
    await nuxt_plugin_dayjsplugin_591e106e(app.context, inject)
  }

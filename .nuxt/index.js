...
import nuxt_plugin_plugin_3195e6e8 from 'nuxt_plugin_plugin_3195e6e8' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_workbox_05c93e3e from 'nuxt_plugin_workbox_05c93e3e' // Source: ./workbox.js (mode: 'client')
import nuxt_plugin_nuxticons_2c3134e6 from 'nuxt_plugin_nuxticons_2c3134e6' // Source: ./nuxt-icons.js (mode: 'all')
import nuxt_plugin_googleanalytics_3b3c9578 from 'nuxt_plugin_googleanalytics_3b3c9578' // Source: ./google-analytics.js (mode: 'client')
import nuxt_plugin_dayjsplugin_f6c3160a from 'nuxt_plugin_dayjsplugin_f6c3160a' // Source: ./dayjs-plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_3195e6e8 === 'function') {
    await nuxt_plugin_plugin_3195e6e8(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_05c93e3e === 'function') {
    await nuxt_plugin_workbox_05c93e3e(app.context, inject)
  }

  if (typeof nuxt_plugin_nuxticons_2c3134e6 === 'function') {
    await nuxt_plugin_nuxticons_2c3134e6(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_googleanalytics_3b3c9578 === 'function') {
    await nuxt_plugin_googleanalytics_3b3c9578(app.context, inject)
  }

  if (typeof nuxt_plugin_dayjsplugin_f6c3160a === 'function') {
    await nuxt_plugin_dayjsplugin_f6c3160a(app.context, inject)
  }
